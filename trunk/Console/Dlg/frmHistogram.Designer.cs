namespace IPPrototyper
{
    partial class frmHistogram
    {
        ...
        {
            this.histogram = new Apache.Controls.Histogram( );
            ...
            this.histogram.SelectionChanged += new Apache.Controls.HistogramEventHandler( this.histogram_SelectionChanged );
            this.histogram.PositionChanged += new Apache.Controls.HistogramEventHandler( this.histogram_PositionChanged );
            // 
            // label1
            // 
        ...
        private Apache.Controls.Histogram histogram;
